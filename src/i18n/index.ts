...
export const i18n = new I18nStore({
  en: {
    ...
    'hero.version': 'Tool Suite v1.1.0',
    ...
    'download.version': 'Tool Suite v1.1.0',
    ...
    'showcase.rooms.title': 'Rooms & Connections',
    'showcase.rooms.description': 'Design room-by-room worlds with a room model, validation rules, binary v7 persistence and C++ export with room metadata. Readable connection panel for room adjacency.',
  ...
  es: {
    ...
    'hero.cta.download': 'OBTENER LA SUITE',
    ...
    'showcase.rooms.title': 'Rooms y Conexiones',
    'showcase.rooms.description': 'Diseña mundos room-by-room con un modelo de rooms, reglas de validación, persistencia binaria v7 y exportación C++ con metadatos de room. Panel legible de conexiones y adyacencia entre rooms.',
