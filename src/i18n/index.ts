...
export const i18n = new I18nStore({
  en: {
    ...
    'hero.version': 'Tool Suite v1.0.0 coming soon',
    ...
    'features.music.description': 'Compose music and sound effects directly in the engine-supported format. Professional tools for retro soundscapes.',
    ...
    'pricing.collector.price_sub': 'Coming Soon',
  ...
  es: {
    ...
    'hero.version': 'Tool Suite v1.0.0 próximamente',
    'hero.title': 'PixelRoot32 Tool Suite',
    ...
    'features.music.description': 'Compón música y efectos de sonido directamente en el formato soportado por el motor.',
    ...
    'pricing.collector.price_sub': 'Próximamente',
    ...
    'pricing.collector.feat5': 'Funciona en Mac y Windows',
